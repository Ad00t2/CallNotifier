...
export function calculateUserRealmPasswordHash(user, realm, password) {
  return kd(unq(user), unq(realm), unq(password));
}

export function calculateHA1(ctx) {
...
export function calculateDigest(ctx) {
  switch(ctx.qop) {
  case 'auth-int':
...
export function extractNonceTimestamp(nonce, tag) {
...
export const challenge = function(ctx, rs) {
...
export const authenticateRequest = function(ctx, rq, creds) {
...
export const signResponse = function(ctx, rs) {
...
export const signRequest = function (ctx, rq, rs, creds) {
  ctx = ctx || {};
  if(rs)
...
export const authenticateResponse = function(ctx, rs) {
